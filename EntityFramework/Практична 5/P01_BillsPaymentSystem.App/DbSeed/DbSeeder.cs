namespace P01_BillsPaymentSystem.App.DbSeed
{
    ...
    {
        private const string NamesFilePath = @"D:\course 2\1.C#\Практичні\PracticalWorks_CSharp\EntityFramework\Практична 5\P01_BillsPaymentSystem.App\DbSeed\TestName.txt";
