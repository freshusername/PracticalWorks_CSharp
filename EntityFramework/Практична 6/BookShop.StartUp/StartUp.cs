    ...
    public class StartUp
    {
        public static void Main()
        {
            using (var context = new BookShopContext())
            {
                ...
                //Console.WriteLine(RemoveBooks(context)); // 15. Remove BooksD:\course 2\1.C#\Практичні\PracticalWorks_CSharp\EntityFramework\Практична 6\BookShop.StartUp\StartUp.cs
            }
        }
